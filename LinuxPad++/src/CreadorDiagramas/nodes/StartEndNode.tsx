...
export default function StartEndNode({ id, data: rawData, selected }: NodeProps) {
  ...
  return (
    ...
    >
      <NodeResizer minWidth={100} minHeight={36} isVisible={selected} color="#60a5fa" />
      ...
      {editing ? (
        ...
        <span style={{ color: '#fff', fontWeight: 600, fontSize: 13, whiteSpace: 'nowrap' }}>{data.label}</span>
      )}
    </div>
  );
}
